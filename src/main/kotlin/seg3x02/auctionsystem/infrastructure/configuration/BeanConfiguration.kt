...
class BeanConfiguration() {
    ...
    fun createAuctionUseCase(userFacade: UserFacade,
                            ...
                            auctionFeeCalculator: AuctionFeeCalculator): CreateAuction {
        return CreateAuctionImpl(userFacade, itemFacade, auctionFacade, auctionScheduler, auctionFeeCalculator)
    }
    ...
    fun auctionFacade(auctionFactory: AuctionFactory,
                      ...
                      eventEmitter: DomainEventEmitter): AuctionFacade {
        return AuctionFacadeImpl(auctionFactory, auctionRepository, bidFactory, bidRepository, eventEmitter)
    }
}
